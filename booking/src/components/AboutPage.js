  ...
  <p className="mt-4">
    To get started, register a new account or login with your existing one.
          ...
          <Card
            ...
            <p className="mt-4">
              If your using the app to market your hotel,switch users to admin and fill in the form with the
              required details.
            </p>
          </Card>
          <Card
          ...
          <Card
            ...
            <p className="mt-4">
              If you're looking for a specific Hotel, simply use the search bar and
              enter the name of the Hotel you're looking for.
            </p>
          </Card>
          <Card
            title="Remove Memes">
            ...
            <p className="mt-4">
              ...
              button on the Hotel you want to delete. Please note that you can only
              update or delete Hotels that you've added.
            </p>
          </Card>
        </div>
      </div>
